...
<div id="mySidenav" class="sidenav">
  ...
  <a href="/Flight/contact.jsp">Contact</a>
       <div class="name">
<% 
...
<div id="cont">
<h1>Welcome to JS Flight Booking System</h1><br>
<h2>Now you don't have to go outside for booking tickets.</h2><br>
<h3>For booking your first online flight ticket just click on the above FLIGHT button</h3>
